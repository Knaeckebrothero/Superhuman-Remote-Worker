...
class TestExtractResponsesApiReasoning:
    ...
    def test_extracts_reasoning_from_summary(self):
        ...
        msg = self._make_message([
            {"type": "reasoning", "summary": [{"type": "text", "text": "Let me think..."}]},
    ...
    def test_extracts_reasoning_from_content_field(self):
        ...
        msg = self._make_message([
            {"type": "reasoning", "content": [{"type": "text", "text": "Step 1"}, {"type": "text", "text": "Step 2"}]},
    ...
    def test_extracts_reasoning_from_both_summary_and_content(self):
        ...
        _extract_responses_api_reasoning(msg)
        assert msg.additional_kwargs["reasoning_content"] == "Summary thought\nDetailed thought"
    ...
    def test_multiple_reasoning_blocks(self):
        ...
        msg = self._make_message([
            {"type": "reasoning", "summary": [{"type": "text", "text": "First thought"}]},
            {"type": "output_text", "text": "Middle text."},
            {"type": "reasoning", "summary": [{"type": "text", "text": "Second thought"}]},
            {"type": "output_text", "text": "Final text."},
        ])
        _extract_responses_api_reasoning(msg)
        assert msg.additional_kwargs["reasoning_content"] == "First thought\nSecond thought"

"""
Pytest configuration and shared fixtures for the vendored citation_engine.

This module provides:
- Shared fixtures for database connections (SQLite + Postgres-by-env)
...
CITATION_DB_URL for the Postgres integration suite — not a local .env file.
"""

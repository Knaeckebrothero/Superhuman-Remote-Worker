...
class TestHeadscaleClientInit:
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_API_KEY", "test-api-key")
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_API_KEY", "")
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_API_KEY", "test-api-key")
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "")
...
class TestInit:
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_API_KEY", "test-api-key")
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    @patch("vm_controller.headscale_client.HEADSCALE_USER", "srw")
    async def test_init_creates_client_and_resolves_user(self):
        ...
        with patch(
            "vm_controller.headscale_client.httpx.AsyncClient", return_value=mock_http
        ):
            await client.init()
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_API_KEY", "test-api-key")
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    @patch("vm_controller.headscale_client.HEADSCALE_USER", "nonexistent")
    ...
    async def test_init_sets_correct_headers(self):
        ...
        with patch(
            "vm_controller.headscale_client.httpx.AsyncClient",
...
class TestCreateAuthKey:
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_API_KEY", "test-api-key")
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    @patch("vm_controller.headscale_client.AUTH_KEY_EXPIRY_MINUTES", 10)
...
class TestLifecycleIntegration:
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    @patch("vm_controller.headscale_client.HEADSCALE_USER", "srw")
    @patch("vm_controller.headscale_client.RETRY_BASE_S", 0.0)
    ...
    @patch("vm_controller.headscale_client.HEADSCALE_URL", "http://headscale:8080")
    @patch("vm_controller.headscale_client.HEADSCALE_USER", "srw")
    @patch("vm_controller.headscale_client.RETRY_BASE_S", 300.0)

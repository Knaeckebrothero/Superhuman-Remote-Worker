-- migration:     0191_notifications.sql
...
-- depends-on:    0190_managed_repository_terminal_thread_delete_validate.sql
--                (0184-0190 are the managed-repository / stateless-input
--                lane; this file only needs 0001 but takes the next free
--                number so the two lanes never collide on a prefix)

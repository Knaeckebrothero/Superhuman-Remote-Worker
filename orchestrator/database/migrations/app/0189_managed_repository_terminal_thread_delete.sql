-- migration:     0189_managed_repository_terminal_thread_delete.sql
-- description:   Recognize a receipt-bound terminal thread marker after its
--                retired runtime UID has been cleared from workspace state.
-- depends-on:    0188_managed_repository_initial_runtime_binding.sql

-- migration:     0188_managed_repository_initial_runtime_binding.sql
-- description:   Distinguish first trusted runtime publication from destructive
--                replacement in the process-zero transition guard.
-- depends-on:    0187_managed_repository_process_zero_authority.sql

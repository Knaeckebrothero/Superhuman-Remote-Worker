...
_CATEGORY_BLOCKS: dict[str, str] = {
    RESEARCHER: (
        "Your deliverable is an ANSWER, not a product increment. This ticket is "
        "a SPIKE: a bounded investigation that ends in a decision, not an "
        ...
        "become follow-up tickets — extending a spike is the officer's "
    ...
    EXECUTOR: (
        ...
        "outside that folder. The ticket's declared deliverables are the one "
        "hard check on this work. "
        ...
        "SCOPE: deliver THIS ticket. Discoveries that deserve their own work "
        "become follow-up tickets. No budget or clock will stop you from "

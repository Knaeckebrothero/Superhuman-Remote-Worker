...
_ROLE_BLOCKS: dict[str, str] = {
    "scholar": (
        ...
        "(multiple delegate_agent calls in one turn) instead of reading every "
    ...
    "critic": (
        ...
        "streams out to subagents (multiple delegate_agent calls in one turn) "
    ...
    "developer": (
        ...
        "(multiple delegate_agent calls in one turn) to explore unfamiliar code "

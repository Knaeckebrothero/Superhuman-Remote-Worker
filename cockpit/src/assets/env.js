(function(window) {
  ...
  window['env']['models'] = [
    ...
    { group: 'OpenAI', models: ['gpt-5.4', 'codex/gpt-5.3-codex', 'codex/gpt-5.3-codex-spark'] },
  ...
  window['env']['modelPresets'] = [
    ...
    { label: 'Codex + Spark', strategic: 'codex/gpt-5.3-codex', tactical: 'codex/gpt-5.3-codex-spark' },

...
- **Workspace files** (inside the workspace container, SSH in to look): `plan.md`, `todos.yaml`, `notes/`, `datasources.md`, `output/`. From your own terminal, editor, or IDE — not just Cockpit's file browser — see [ssh-access.md](ssh-access.md).

...
Optional environment:
  ...
  CANVAS_VIEWER_SECRET_USERNAME_KEY (default: username)
  CANVAS_VIEWER_SECRET_PASSWORD_KEY (default: password)
...
CANVAS_VIEWER_SECRET_USERNAME_KEY="${CANVAS_VIEWER_SECRET_USERNAME_KEY:-username}"
CANVAS_VIEWER_SECRET_PASSWORD_KEY="${CANVAS_VIEWER_SECRET_PASSWORD_KEY:-password}"

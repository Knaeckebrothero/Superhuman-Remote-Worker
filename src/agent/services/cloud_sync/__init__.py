...
from agent.services.cloud_sync.base import SYNC_IGNORE_PATTERNS, WorkspaceSyncBase
...
from agent.services.cloud_sync.opencloud_sync import OpenCloudWorkspaceSync

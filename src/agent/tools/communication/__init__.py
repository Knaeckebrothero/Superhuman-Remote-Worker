...
def create_communication_tools(context: ToolContext) -> List[Any]:
    ...
    """
    from agent.tools.communication.messaging import (
        create_communication_tools as _create,
    )
...
def get_communication_metadata() -> Dict[str, Dict[str, Any]]:
    ...
    from agent.tools.communication.messaging import COMMUNICATION_TOOLS_METADATA

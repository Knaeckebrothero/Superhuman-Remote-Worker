...
def create_workflow_tools(context: ToolContext) -> List[Any]:
    ...
    """
    from agent.tools.research.utils.network import get_proxy_from_context
...
async def _search_arxiv_raw(query: str, max_results: int):
    ...
    from agent.tools.research.utils.arxiv_client import ArxivClient
...
async def _search_semantic_scholar_raw(query: str, max_results: int, *, proxy=None):
    ...
    from agent.tools.research.utils.paper_types import AccessStatus, Paper, PaperSource
...
def _deduplicate_papers(arxiv_papers, s2_papers):
    ...
    """
    from agent.tools.research.utils.paper_types import Paper
...
async def _download_available_papers(
    ...
    *,
    ...
    """
    from agent.tools.research.utils.paper_types import AccessStatus
...
async def _download_single_url(
    ...
    from agent.tools.research.utils.network import research_request

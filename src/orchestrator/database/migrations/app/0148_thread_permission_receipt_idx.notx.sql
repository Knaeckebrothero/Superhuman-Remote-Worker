-- migration:     0148_thread_permission_receipt_idx.notx.sql
-- description:   Enforce one durable journal receipt per exact-lease
--                permission request without blocking thread-event writers.
-- depends-on:    0147_thread_permission_lease_receipts.sql
...
--                        idx_thread_events_permission_request;
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_thread_events_permission_request

...
src/shared/runtime/core/capability_grants.py; this is the DB glue (mirrors config_resolver's
...
from shared.runtime.core.capability_grants import resolve_grants

...
**Status:** investigated 2026-07-05 — root cause confirmed end-to-end from the live wedge, incident recovered by hand; **fix 2 (sweeper self-heal) IMPLEMENTED & k3d-verified 2026-07-05** (see "Fix directions"); fixes 1 (advance atomicity) and 3 (UI stalled badge) still open

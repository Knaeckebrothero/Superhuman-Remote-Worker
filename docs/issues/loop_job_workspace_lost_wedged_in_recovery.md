...
**Found:** 2026-06-27. Job `19707fa1-1788-4eda-a296-8b108429b108` (Loop iter 3 · DEVELOPER — "Build an ERP for Hotel Rheinland in Bad Orb"), project `68137e29-6b1f-4f1b-a0c1-4e6dc2be3f9a`, owner `knaeckebrothero` / `operator@redacted.invalid`, main cluster (ns `superhuman-remote-worker`).

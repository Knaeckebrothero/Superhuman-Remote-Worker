...
**Status:** Investigation complete, root cause isolated + **measured on the live main cluster**. Not yet fixed. Two distinct defects (a write-side bloat + a read-side amplifier); either fix alone stops the OOM.

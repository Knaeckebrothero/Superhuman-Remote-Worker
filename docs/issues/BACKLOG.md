...
| doc | why now |
|---|---|
| [officer_control_plane_post_implementation_audit](officer_control_plane_post_implementation_audit.md) | **INDEX — keep `auto_pull` off.** The six pre-deployment findings, BP-02/BP-03/BP-04, OC-03, BP-05/BP-06 and BP-07/BP-08/BP-10 are closed locally. O6 was released successfully with `auto_pull=false`; the later correctness checkpoints remain undeployed. Do not close the index until the remaining release and live gates pass. |

...
**Status:** Investigation complete, root causes isolated on the live main cluster. Three distinct defects, causally chained (A → B → C below). **P1 + P2 (all of Track 1) implemented + verified (local + k3d) 2026-06-27, uncommitted on `develop`** — see the Implementation status note under Sequencing. Only Track 2 (Defect C circuit breaker) remains.

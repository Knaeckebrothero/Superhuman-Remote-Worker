...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `fe60f945`/`9b2aef02`/`0ae73e80` — auxiliary provider field + openrouter/ auto-detect + AuxHealth fallback; tests/test_auxiliary_fallback.py 22/22 green.

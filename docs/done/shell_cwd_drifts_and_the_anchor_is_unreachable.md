...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `f41970ae`+`e7d29b2d`, hardened `22b2511e`/`95899228` — all four slices + tests verified at HEAD. Residue stays open as documented: unquoted sync-path `cd` f-strings and no live-tmux e2e.

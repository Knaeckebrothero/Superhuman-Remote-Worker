...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Part 1 `2acbbb2c` + Part 2 `0551521d` (5-segment DB overlay, phase-directive fencing, migration 0036) verified at HEAD; content-hygiene remainder explicitly deferred.

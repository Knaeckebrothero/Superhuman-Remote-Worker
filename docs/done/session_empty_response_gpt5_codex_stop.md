...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `7ceb4d12` — bounded ainvoke retry + thinking.reset live-replace across graph/app/cockpit; TestEmptyResponseRetry 7/7 green.

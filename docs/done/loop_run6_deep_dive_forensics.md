...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Investigation archive — F29's recommended dispatch-time URL rewrite has since shipped for the JOB path (externalize_gitea_url in _dispatch_job_to_agent); the session/thread twin remains open in vm_session_thread_repo_clone_unroutable_gitea_url.md.

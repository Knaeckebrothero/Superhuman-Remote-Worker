...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** All 8 ✅-marked issues verified shipped at HEAD (commits recorded inline); issues 1/2/3/4/6/11/15 deliberately deferred and 9 pending prod-private connect — exactly as the doc's own tracking states.

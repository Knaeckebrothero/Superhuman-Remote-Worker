...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** resolve_ssh_key_path() stages an atomic 0600 runtime-owned copy exactly per spec; tests/test_ssh_key_path.py 4/4 green live. Original SHA rebased away; code + tests unambiguous.

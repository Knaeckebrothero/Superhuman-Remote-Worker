...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Superseded — the gap this proposal targets was closed by running the real Helm chart on local k3d (verified end-to-end 2026-05-28), not by Docker-simulated VMs; none of its artifacts were built.

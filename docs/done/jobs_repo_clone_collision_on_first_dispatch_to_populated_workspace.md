...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Committed `47c65582` (+`08a1bd3e` same-day hardening) — the attach probe normalizes remote URLs; function since renamed _attach_existing_workspace_repo. The 'Remaining work' checklist is moot.

...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Investigation archive — its corrections verified (spawn_subagent live via `e65d5e32`/`a4596376`); its T1.3 recommendation (developer light fan-out) has since been implemented.

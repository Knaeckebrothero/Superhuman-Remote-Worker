...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Everything except #15 shipped: #1-3, 8-14, 16 verified individually at HEAD (several code comments cite this doc); #4-full/#5/#6/#7 landed via docs/features/context_summarization_rework.md. #15 (no repro) remains the only open row.

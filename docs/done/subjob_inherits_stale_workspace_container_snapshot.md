...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `5a6f5a49`+`ff472727`, hardened `73fbea49` — live-workspace resolver + dispatch backstop wired; tests/test_subjob_inherited_workspace.py 27/27 green.

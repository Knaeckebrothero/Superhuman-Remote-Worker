...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `a2072682` — completion_error_payload() preserves the error type through the streaming except-path and all four app-layer sites; regression test classes present.

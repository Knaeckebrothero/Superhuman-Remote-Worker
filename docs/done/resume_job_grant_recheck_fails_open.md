...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `b71aee72`+`915cb49a`+`4fd13de7` — deterministic resolve_config failures now fail closed (409), transient path preserved; TestResumeEndpointGrantRecheck ×7. The dispatcher twin stays open in dispatcher_resume_pep_twin_still_fails_open.md.

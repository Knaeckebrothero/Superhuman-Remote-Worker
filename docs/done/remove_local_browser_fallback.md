...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Verified at HEAD (`fc42d052`): zero browser_use/local-fallback symbols under src/ or tests/, requirements + Dockerfile clean, regression guard test present.

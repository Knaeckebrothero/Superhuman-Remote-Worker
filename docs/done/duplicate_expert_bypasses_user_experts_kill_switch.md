...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `55080ed0`, refined `b0333217`/`0edbd9bc` (copy-routes strip-to-grants-and-report; create/update/import keep the hard refuse); pinned by the parametrized 5-route kill-switch test.

...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `4b4d2989` (original fix + the 07-23 sub-cap follow-up squashed into one commit); tests/test_model_registry.py 61/61 green at HEAD.

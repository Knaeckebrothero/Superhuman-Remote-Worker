...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** All three bugs shipped: full-history default + cursor paging (postgres.py docstring cites this doc verbatim), the four i18n keys, and the control-WS watchdog + visibilitychange/online reconnect + postInput retry banner.

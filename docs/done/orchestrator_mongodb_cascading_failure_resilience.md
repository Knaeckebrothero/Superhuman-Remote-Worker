...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Component retired (`f1b06621`) — the Mongo audit backend was replaced by the srw-auditdb Postgres store with non-fatal failure semantics; this cascading-failure scenario cannot recur. Any analogous Postgres-audit risk needs a fresh doc.

...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Committed `84fa3e05` (the Status line's UNCOMMITTED was stale) — ResizeObserver detector + pure pin helpers + wheel/touch escape + CSS wins, with unit tests. Fix 4 (iOS visualViewport) and Fix 5 (connect waterfall) deliberately not done — reopen separately if they bite.

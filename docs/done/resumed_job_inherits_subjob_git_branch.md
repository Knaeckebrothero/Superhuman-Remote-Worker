...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `e71f343c`+`e943093e` — ensure_job_branch at all three attach-to-existing-tree sites incl. pod handoff; tests/test_resume_job_branch_restore.py 9/9 green.

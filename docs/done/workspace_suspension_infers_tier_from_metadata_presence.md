...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `6d66f7c4`+`24aed290` — _thread_is_vm_tier() reads the tier explicitly; TestThreadTierIsExplicit + TestUpgradedThreadReadsAsVmTier pin it. The snapshot-unreachable-over-tailnet gate stays open in its own doc.

...
Still open from the original "out of scope" list: the **`425 /connection` stream storm** (see `resumed_session_dead_stream_and_supervised_gate_timeout_as_denial.md`) and the reload "completed" mislabel.

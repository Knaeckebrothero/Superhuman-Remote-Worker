...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Ancient point-in-time debugging log — spot-checked items all resolved (workspace.py path calc fixed exactly as proposed, handle_transition now async, MCP surface grew 8 → 112 tools).

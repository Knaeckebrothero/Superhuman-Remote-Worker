...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Shipped `9c987f30` — idle BFF session re-validates in place (id_token write-back) + cockpit draft persistence; tests/test_bff_session_auth.py 26/26 green.

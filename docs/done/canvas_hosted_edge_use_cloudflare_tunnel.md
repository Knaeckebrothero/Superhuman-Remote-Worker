...
**Closed by the 2026-08-06 doc-truth sweep (batch #3):** Root-repo checklist (items 4-8) verified at HEAD: tunnel-scoped NetworkPolicy selectors, rawPathVerified demoted + fail-closed check removed, verify-script raw-path probe opt-in, optional Ingress template, ops doc rewritten. HomeLab items (1-3) live outside this repo.

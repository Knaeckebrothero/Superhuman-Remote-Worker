...
Delegate reading to `reader` children with bounded returns: one question each, a compact evidence-backed answer back; you synthesise and author every artifact and note. A thin or empty return is a gap to re-spawn narrower or mark uncovered.
{% endif -%}

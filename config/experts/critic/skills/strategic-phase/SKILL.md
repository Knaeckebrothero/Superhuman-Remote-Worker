...
Delegate evidence gathering to `verifier` children — one per independent stream, in one turn. They return per-criterion evidence with file:line and exact output; they never approve or reject. The verdict is yours.
{% endif -%}
